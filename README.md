...
- Full-stack RAG application (~3,400 lines, 95% solo) deployed across two active Duke research labs ingesting papers, protocols, and lab knowledge bases into lab-specific AI assistants
- Achieved a semantic chunking breakthrough improving retrieval accuracy from 60% to ~90% at ~$0.002/doc across 200+ test queries; deployed on AWS with Docker and GitHub Actions CI/CD
- **Stack:** Python · LangChain · ChromaDB · Anthropic API · OpenAI API · React.js · FastAPI · PostgreSQL · Docker · AWS
