...
🔗 linkedin.com/in/alexliu22 · ayl32@duke.edu

👀 Interests

AI agents · LLMs · RAG systems · prompt engineering
ML pipelines at scale · genomics · computational biology
...
Email: ayl32@duke.edu
LinkedIn: linkedin.com/in/alexliu22
...
Enables semantic search and conversational querying across 500+ academic documents with ~90% retrieval accuracy
...
🧰 Technical Stack
Languages: Python · Java · JavaScript · TypeScript · C · R · SQL · HTML/CSS
Frameworks: React.js · FastAPI · LangChain · ChromaDB
AI/ML: OpenAI API · Claude API · RAG · LLMs · Prompt Engineering · Agent Evaluation
Tools: Git · Linux · AWS · GitHub Copilot · Figma
